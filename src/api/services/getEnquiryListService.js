...
exports.getEnquiryList = async (data) => {
    try {
        ...
        if (data.search_criteria) {
            if (data.sbu_id == 0) {
                if (data.search_criteria.startsWith('e000')) {
                    searchCondition = "WHERE e.enquiry_id = " + data.search_criteria.substring(4) + ""
                }
                else {
                ...
                if (data.search_criteria.startsWith('e000')) {
                    searchCondition = "AND e.enquiry_id LIKE '%" + data.search_criteria.substring(4) + "%'"
                }
                else {
