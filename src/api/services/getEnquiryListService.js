...
exports.getEnquiryList = async (data) => {
    try {
        ...
        if (data.no_of_records == "all") {
            ...
            return [enquiry_list, [0,0], [0,0], [0,0]]
