...
exports.getSegmentsByState = async (data) => {
    try {
        ...
        let sql2 = "SELECT DISTINCT c.segment_id, s.segment_name as name FROM customer c JOIN segment s ON c.segment_id = s.segment_id WHERE c.customer_id IN (?) "+ select_condition +""
