...
exports.getDashboardCount = async (data) => {
    try {
        ...
        if(data.sbu_id == 0) {
            ...
            let sales_person_count_sql = "SELECT count(sales_person_id) as total_sales_person FROM sales_person"
            ...
            if(data.check_designation_id == 1) {
                ...
                let sales_person_count_sql = "SELECT count(sales_person_id) as total_sales_person FROM sales_person WHERE sbu_id = ?"
