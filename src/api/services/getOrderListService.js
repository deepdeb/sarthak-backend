...
exports.getOrderList = async (data) => {
    try {
        ...
        if(data.order_offset) {
            searchCondition2 = "OFFSET " + data.order_offset + ""
        }
