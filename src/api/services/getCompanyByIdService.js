...
exports.getCompanyById = async (data) => {
    try {
        let get_company_by_id_sql = "SELECT sb.sbu_name, sb.contact_person, sb.contact_number, sb.email, sb.address, sb.city, sb.state_id, st.state_name, sb.pin FROM sbu sb JOIN state st ON st.state_id = sb.state_id WHERE sb.sbu_id = ?"
