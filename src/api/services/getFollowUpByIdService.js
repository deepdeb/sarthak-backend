...
exports.getFollowUpById = async (data) => {
    try {
        let follow_up_select_sql = "SELECT follow_up_id, enquiry_id, DATA_FORMAT(status_date, '%Y-%m-%d') as status_date, status, remarks, support FROM follow_up WHERE enquiry_id = ?"
